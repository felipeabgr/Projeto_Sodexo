# Django settings for sodexoapp project.
import os
...
SECRET_KEY = 'asvf9d5&@a7ee4z^x25g9-^ad_@09y#++$j!8k17@wozn3qj5c'
...
ROOT_URLCONF = 'sodexoapp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sodexoapp.wsgi.application'
